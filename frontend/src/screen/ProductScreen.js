                ...
                <div className="container">
                  <div className="d-flex flex-row">
                    <div className="flex-row-fluid">
                      <div className="row">
                        <div className="col-md-7 col-lg-12 col-xxl-7">
                              ...
                              <div className="d-flex">
                                {product.countInStock > 0 && 
                                  <button type="button" onClick={handleAddToCart} className="btn btn-primary font-weight-bolder mr-6 px-6 font-size-sm">
                                    <span class="svg-icon svg-icon-white"><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
